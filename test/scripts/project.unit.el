...
(describe "lelde/project empty project (only .gitignore)"
  (let* ((project-path nil)
    ...
    (it "assertions"
      ...
      (should (equal (plist-get pinfo :template-alist)
                     '(("src/c0000.bundled.el" "c0000.el")
      ...
      (should (memq :url pinfo))
      (should (memq :keywords pinfo))
      (should (equal   (plist-get pinfo :files-to-update)
                       '("Makefile" "Cask" "src/c0000/META.el" "recipe/c0000")))
